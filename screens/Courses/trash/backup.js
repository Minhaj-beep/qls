...
const LiveClass = ({navigation, route}) => {
  ...
  const pc = useRef(new RTCPeerConnection({ iceServers: [] }));
    ...
    mediaDevices.getUserMedia({
        ...
        .then((stream) => {
            ...
            peer = new Peer(undefined, {
                location: "live.qlearning.academy/peerjs",
            });
            ...
            peer.on("open", (id) => {
                ...
                alert("join-room", id)
                socket.emit("join-room", { roomName: LiveClassData.liveUUID, peerId: id, userName: UserName });
            ...
            peer.on("call", (call) => {
                ...
                call.on("stream", (userVideoStream) => {
                  ...
                  setRemoteStream(userVideoStream.toURL())
                });
            });
  ...
  const joinRoom = () => {
    ...
    const roomName = LiveClassData.liveUUID
    // const roomName = "e5266a97-e7bc-4a7b-bc0d-9d7db5ba4777"
  ...
  return (
    <View style={styles.TopContainer}>
      ...
      <View style={{width:"95%", alignSelf:"center"}}>
        ...
        <RTCView style={styles.courseImg} streamURL={remoteStream} zOrder={0} objectFit='cover' />
        {/* <RTCView 
          key={2}
          streamURL={{}}
        ...
        <Text style={{fontWeight:"600", fontSize:15}}>{LiveClassData.topicName}</Text>
      </View>
